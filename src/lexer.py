...
class TokenType(Enum):
    ...
    KEYWORD_VAR = r"(var)\b"
    KEYWORD_INTEGER = r"(integer)\b"
    KEYWORD_REAL = r"(real)\b"
    KEYWORD_IF = r"(if)\b"
    KEYWORD_THEN = r"(then)\b"
    KEYWORD_ELSE = r"(else)\b"
    KEYWORD_BEGIN = r"(begin)\b"
    KEYWORD_END = r"(end)\b"
    KEYWORD_WHILE = r"(while)\b"
    KEYWORD_DO = r"(do)\b"
    KEYWORD_WRITE = r"(write)\b"
    KEYWORD_READ = r"(read)\b"
    KEYWORD_PROGRAM = r"(program)\b"
    KEYWORD_PROCEDURE = r"(procedure)\b"
